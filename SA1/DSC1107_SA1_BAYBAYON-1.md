...
This model accurately predicts 51.8% of customer churn. Since this is a
...
``` r
model_lr <- glm(Class~ Tenure + MonthlyCharges + TotalCharges,
                data=data_train, family="binomial")
coef(model_lr)
```

    ##    (Intercept)         Tenure MonthlyCharges   TotalCharges 
    ##  -8.397549e-02   3.500385e-03   7.609835e-04  -3.871706e-05
...
![](DSC1107_SA1_BAYBAYON-1_files/figure-gfm/unnamed-chunk-16-1.png)<!-- -->
...
![](DSC1107_SA1_BAYBAYON-1_files/figure-gfm/unnamed-chunk-16-2.png)<!-- -->
...
The model has an accuracy of 47.91%, precision of 47.82% and recall of
42.22%. These indicate poor overall performance of the model.
...
![](DSC1107_SA1_BAYBAYON-1_files/figure-gfm/unnamed-chunk-18-1.png)<!-- -->

``` r
plot_glmnet(lasso_fit, data_train)
```

![](DSC1107_SA1_BAYBAYON-1_files/figure-gfm/unnamed-chunk-18-2.png)<!-- -->
...
``` r
plot_glmnet(glmnet_fit = lasso_fit, data= data_train, features_to_plot = 4)
```

![](DSC1107_SA1_BAYBAYON-1_files/figure-gfm/unnamed-chunk-18-3.png)<!-- -->
