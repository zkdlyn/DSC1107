...
This model accurately predicts 51.8% of customer churn. Since this is a binary classification, this accuracy is only slightly better than random guessing.  50% of the churn instances predicted by the model were truly positive and correctly identified  45.9% of churn instances. the F score of F=0.47 suggests that the model exhibited moderate performance,.
...
The model has an accuracy of 47.91%, precision of 47.82% and recall of 42.22%. These indicate poor overall performance of the model. 
